...
(function (a) {
    ...
    var b = new Hashtable, c = ["ae", "au", "ca", "cn", "eg", "gb", "hk", "il", "in", "jp", "sk", "th", "tw", "us"], d = ["at", "br", "de", "dk", "es", "gr", "it", "nl", "pt", "tr", "vn"], e = ["cz", "fi", "fr", "ru", "se", "pl"], f = ["ch"], g = [
        [".", ","],
        [",", "."],
        [",", " "],
        [".", "'"]
    ...
    a.fn.formatNumber = function (b, c, d) {
        ...
        var c = a.extend({}, a.fn.formatNumber.defaults, c), d = k(c.locale.toLowerCase(), c.isFullLocale), e = d.dec, f = d.group, g = d.neg, h = "0#-,.", i = "", j = !1;
        ...
        var c = a.extend({}, a.fn.formatNumber.defaults, c), g = k(c.locale.toLowerCase(), c.isFullLocale), h = g.dec, i = g.group, j = g.neg, l = !1;
        if (isNaN(b)) {
        ...
        if (c.format.indexOf(".") > -1) {
            ...
            if (c.round == 1)b = new Number(b.toFixed(o.length)); else {
                var p = b.toString();
        ...
        if (u != 0 || v.substr(v.length - 1) != "#" || l) {
            ...
            if (v.length > w.length) {
                var A = v.indexOf("0");
                if (A != -1) {
                    var B = v.length - A, C = v.length - w.length - 1;
                    while (w.length < B) {
                        var D = v.charAt(C);
                        D == "," && (D = i), w = D + w, C--
                    }
        ...
        var c = a.extend({}, a.fn.parseNumber.defaults, c), d = k(c.locale.toLowerCase(), c.isFullLocale), e = d.dec, f = d.group, g = d.neg, h = "1234567890.-";
        ...
        return m
    }, a.fn.parseNumber.defaults = {locale:"us", decimalSeparatorAlwaysShown:!1, isPercentage:!1, isFullLocale:!1}, a.fn.formatNumber.defaults = {format:"#,###.00", locale:"us", decimalSeparatorAlwaysShown:!1, nanForceZero:!0, round:!0, isFullLocale:!1}, Number.prototype.toFixed = function (b) {
    ...
    d.prototype.init = function (b, d) {
        ...
        if (this.settings.heterogeneity && this.settings.heterogeneity.length > 0) {
            ...
            for (var e = 0; e <= b.length; e++) {
                if (b[e])var f = b[e].split("/"); else var f = [100, this.settings.to];
        ...
        if (this.settings.heterogeneity && this.settings.heterogeneity.length > 0) {
            ...
            for (var f = 0; f <= c.length; f++) {
                if (c[f])var g = c[f].split("/"); else var g = [100, this.settings.to];
